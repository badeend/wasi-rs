...
macro_rules! __export_proxy_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        ...
        "component-type:wit-bindgen:0.38.0:wasi:http@0.2.3:proxy:imports and exportsrust-wasi-from-crates-io-proxy-world")]
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.38.0:wasi:http@0.2.3:proxy-with-all-of-its-exports-removed:encoded worldrust-wasi-from-crates-io-proxy-world"
)]
#[doc(hidden)]
...
nent\x070.224.0\x10wit-bindgen-rust\x060.38.0";
#[inline(never)]
#[doc(hidden)]
